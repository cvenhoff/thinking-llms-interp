...
# Usage examples:
#   # ORZ-1.5B
#   CUDA_VISIBLE_DEVICES=2 MODEL_SIZE=1.5b bash run_legacy_eval.sh
#   # ORZ-0.5B  
#   CUDA_VISIBLE_DEVICES=2 MODEL_SIZE=0.5b bash run_legacy_eval.sh
#   # override coef
#   CUDA_VISIBLE_DEVICES=2 MODEL_SIZE=1.5b FIXED_COEF=0.5 bash run_legacy_eval.sh
# ============================================================
set -e
...
# Sanity: verify required files exist
...
echo ""
echo "======================================"
echo " Hybrid eval: ORZ-${MODEL_SIZE}"
...
python hybrid_eval.py \
    ...
    --hybrid_gen_batch_size "$BATCH_SIZE" \
    ...
    --results_suffix "${RESULTS_SUFFIX}_coef${FIXED_COEF}" \
    "$@"

echo ""
echo "======================================"
echo " Eval DONE: ORZ-${MODEL_SIZE}, coef=${FIXED_COEF}"
echo "======================================"
