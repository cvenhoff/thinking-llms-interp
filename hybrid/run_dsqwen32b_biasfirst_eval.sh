#!/bin/bash
# Hybrid eval for the DeepSeek-R1-Distill-Qwen-32B / Qwen2.5-32B bias-first pipeline.
...
run_one "dsq-bf-learn-128"     ""
run_one "dsq-bf-rand-128"      "--randomize_vectors --random_seed 42"
run_one "dsq-bf-biasonly-128"  "--bias_only"

echo
echo "ALL DSQ EVAL DONE."
