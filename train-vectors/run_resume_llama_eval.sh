#!/bin/bash
# Resume Llama 8B pipeline from Step 2 (re-derive best layers with min_layer_frac) onwards
set -e
...
# ==============================================================================
# Clean old artifacts that will be regenerated
# ==============================================================================
echo "Cleaning old hybrid artifacts..."
# ==============================================================================
# STEP 2b: Re-derive best layers from existing attribution (with min_layer_frac)
# ==============================================================================
echo ""
echo "=============================================="
echo "STEP 2b: Re-derive best layers (min_layer_frac=0.2) + re-plot attribution"
echo "=============================================="
...
echo ""
echo "=============================================="
echo "PIPELINE RESUME COMPLETE (Llama 8B)"
echo "=============================================="
