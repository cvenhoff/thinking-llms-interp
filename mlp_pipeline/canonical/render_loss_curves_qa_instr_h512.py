...
Outputs (under mlp_pipeline/canonical/figs/loss_curves_qa_instr_h512/):
...
ROOT = Path("/workspace-vast/constantinv/thinking-llms-interp")
VECT = ROOT / "mlp_vectors_qa_instr_h512"
OUT  = ROOT / "mlp_pipeline/canonical/figs/loss_curves_qa_instr_h512"
